...
// the "FULL payload == sizeof(MQTTPrefs)" invariant the static_assert below locks.
...
static_assert(offsetof(MQTTPrefs, mqtt_config_enabled) == MQTT_PREFS_V1_PRE_CONFIG_PAYLOAD_SIZE,
